  ...
  if (pipePosition <= pipeRefer && pipePosition > 0 && marioPosition < pipe.height) {
   ...
   //
    ...
    if (score>gameData.maxScore){
      ...
      newRecord.textContent = `newRecord:${gameData.maxScore*10}`;
